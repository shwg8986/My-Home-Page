...
import { AppBar, Box, Typography, Link, Toolbar, IconButton, Menu, Container, Avatar, Button, Tooltip, MenuItem } from '@mui/material';
                        ...
                        <Box sx={{
                            ...
                            <Tooltip title="Link">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                    <Avatar alt="icon" src="/static/images/avatar/HMDIcon.png"
                                        sx={{
                                            width: 30,
                                            height: 30,
                                            borderStyle: "solid",
                            ...
                            >
                                {snss.map((sns) => (
                                    <Link key={sns.name} href={sns.URL} target="_blank" textAlign="center"
                                        sx={{
                                            fontSize: 18,
                                            textDecoration: "none",
                                        }}
                                    >
                                        <MenuItem key={sns.name} onClick={handleCloseUserMenu} sx={{
                                            p: "18px 40px",
                                            color: "#3399ff",
                                            backgroundColor: "#0A1929",
                                            ":hover": {
