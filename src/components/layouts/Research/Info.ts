...
export const Journals = [
    createData('S. Shimada, P. Pannattee, Y. Ikei, N. Nishiuchi, and V. Yem, "High-Frequency Cybersickness Prediction Using Deep Learning Techniques with Eye-Related Indices,"  in IEEE Access, 2023. doi: 10.1109/ACCESS.2023.3312216 (to appear) [査読あり]'),
];
